...
class _NewExpenseState extends State<NewExpense> {
  ...
  Categoty _slectedCategory = Categoty.leisure;
  ...
  void _submitExpancedata() {
    ...
    final invaildAmount = enterdAmount == null || enterdAmount <= 0;
  ...
  Widget build(context) {
    final keyoardSpace = MediaQuery.of(context).viewInsets.bottom;
    return LayoutBuilder(builder: (ctx, constraints) {
      ...
      return SizedBox(
        ...
        child: SingleChildScrollView(
          child: Padding(
              padding: EdgeInsets.fromLTRB(16, 16, 16, keyoardSpace + 16),
              child: Column(
                children: [
                  if (width >= 600)
                    Row(
