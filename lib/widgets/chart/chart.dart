...
class Chart extends StatelessWidget {
  ...
  double get maxTotalExpense {
    ...
    for (final bucket in buckets) {
      if (bucket.tottalExpenses > maxTotalExpense) {
        maxTotalExpense = bucket.tottalExpenses;
      }
    }
            ...
            child: Row(
              ...
              children: [
                for (final bucket in buckets) // alternative to map()
                  ChartBar(
                    fill: bucket.tottalExpenses == 0
                        ? 0
                        : bucket.tottalExpenses / maxTotalExpense,
                  )
              ],
            ),
          ),
